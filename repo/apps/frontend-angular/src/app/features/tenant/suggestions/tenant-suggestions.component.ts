      ...
      <div class="max-w-4xl mx-auto">
        ...
        <header class="mb-12 animate-fade-in-up">
          <div class="flex justify-between items-end">
            <div>
              ...
              <p class="text-[#456882] font-bold uppercase tracking-[0.3em] text-[10px] mt-2">Voice your opinion and vote</p>
            </div>
        ...
        <div *ngIf="showForm" class="mb-12 animate-fade-in-up stagger-1">
          <app-ui-card title="MAKE A SUGGESTION">
            <div class="space-y-6">
              <div class="space-y-2">
                <label class="text-[10px] font-black text-[#456882] tracking-widest uppercase pl-1">Title</label>
                <input 
              ...
              <div class="space-y-2">
                <label class="text-[10px] font-black text-[#456882] tracking-widest uppercase pl-1">Details</label>
                <textarea 
